...
| Peer replication     | libp2p `/adamant/replication/1.1.0`, not an HTTP route                                                                                                 | Authenticated by the libp2p handshake; accepted only from the peers listed in `nodes` |
